  ...
  <template v-if="!loading && formattedPlace">
    ...
    >
      <div>
        ...
        <p class="mt-3 text-lg opacity-80">{{ formattedPlace.date }}</p>
      </div>
      <div class="mt-4 inline-flex items-center gap-5 md:mt-0">
        ...
        <p class="text-8xl italic">{{ formattedPlace.temperature }}</p>
      </div>
    </section>
    <section class="mt-5 grid grid-cols-2 gap-4 md:grid-cols-4 xl:mt-8 xl:gap-6">
      <div class="rounded-xl border border-neutral-600 bg-neutral-800 p-5">
        ...
        <p class="mt-6 text-4xl font-light">{{ formattedPlace.feelsLike }}</p>
      </div>
      <div class="rounded-xl border border-neutral-600 bg-neutral-800 p-5">
        <p class="text-lg text-neutral-200">Humidity</p>
        <p class="mt-6 text-4xl font-light">{{ formattedPlace.humidity }}</p>
      </div>
      <div class="rounded-xl border border-neutral-600 bg-neutral-800 p-5">
        <p class="text-lg text-neutral-200">Wind</p>
        <p class="mt-6 text-4xl font-light">{{ formattedPlace.wind }}</p>
      </div>
      <div class="rounded-xl border border-neutral-600 bg-neutral-800 p-5">
        <p class="text-lg text-neutral-200">Precipitation</p>
        <p class="mt-6 text-4xl font-light">{{ formattedPlace.precipitation }}</p>
      </div>
    </section>
  </template>
